...
| **D** | Classements livreurs (mensuel, m
asqué pour pairs, complet pour admin) |
...
Paliers :
  Bronze  (0–200 pts)   → pas de réduction
  Argent  (200–500 pts) → -10% sur tarif de base
  Or      (500+ pts)    → -20% sur tarif de base

Parrainage :
  Client crée son code unique → partage → filleul crée 1er colis jusqu'à livraison → 500 XOF crédités à chacun
